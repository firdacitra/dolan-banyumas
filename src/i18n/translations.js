...
const translations = {
	id: {
		...
		changeLanguageConfirm: "Anda yakin ingin mengganti bahasa menjadi English?",
		cancel: "Batal",
		ok: "Oke",
		...
		all: "Semua",
		touristAttractions: "Objek Wisata",
		culinary: "Kuliner",
		accommodation: "Penginapan",
		souvenirs: "Oleh-oleh",
		touristVillage: "Desa Wisata",
		travelAgency: "Biro Perjalanan",
		viewDetail: "Lihat selengkapnya",
		loadingFavorites: "Memuat favorit...",
		noFavorites: "Belum Ada Favorit",
		noFavoritesDesc: "Item yang kamu sukai akan muncul di sini",
		exploreNow: "Jelajahi Sekarang",
		loginRequired: "Silakan login untuk melihat favorit",
		removeFromFavorites: "Hapus dari Favorit",
		removeFromFavoritesConfirm: "Apakah Anda yakin ingin menghapus",
		delete: "Hapus",
		success: "Berhasil",
		failed: "Gagal",
		error: "Error",
		errorOccurred: "Terjadi kesalahan",
		failedToRemove: "Gagal menghapus favorit",

		// === LAST SEEN SCREEN ===
		lastSeenTitle: "Terakhir dilihat",
		...
		// === HOME SCREEN ===
		homeTitle: "Dolan Banyumas",
		login: "Login",
		recommendations: "Rekomendasi buat kamu",

		// === SEARCH SCREEN ===
		searchPlaceholder: "Cari wisata, kuliner, penginapan...",
	...
	en: {
		...
		// === LANGUAGE SCREEN ===
		chooseLanguage: "Language Settings",
		...
		// === ACCESSIBILITY SCREEN ===
		darkMode: "Dark Mode",
		darkModeDesc: "More comfortable display for your eyes",
		...
		deleteAccountConfirmation: "Confirm Delete Account",
		...
		souvenirs: "Souvenirs",
		touristVillage: "Tourist Village",
		travelAgency: "Travel Agency",
		viewDetail: "View details",
		loadingFavorites: "Loading favorites...",
		noFavorites: "No Favorites Yet",
		noFavoritesDesc: "Items you like will appear here",
		exploreNow: "Explore Now",
		loginRequired: "Please login to view favorites",
		removeFromFavorites: "Remove from Favorites",
		removeFromFavoritesConfirm: "Are you sure you want to remove",
		delete: "Remove",
		success: "Success",
		failed: "Failed",
		error: "Error",
		...
		// === SEARCH SCREEN ===
		searchPlaceholder: "Search attractions, culinary, hotels...",
